...
$tablesExistCheck = mysqli_query($con, "SHOW TABLES LIKE 'adm_users'");
if ($tablesExistCheck && mysqli_num_rows($tablesExistCheck) > 0)
	exit('install.php already run, tables already exist, aborting to prevent re-running against a live database');
