  ...
  <div class="card-body table-responsive m-0 p-0">
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr class="<?= $order['error_priority'] == 2 ? 'table-danger' : ''?>" onclick="window.location.href='<?= $data['config']['HOST'] . '/design.php?action=order_info_card&id=' .
